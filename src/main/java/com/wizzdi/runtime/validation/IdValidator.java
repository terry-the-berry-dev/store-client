package com.wizzdi.runtime.validation;
  ...
  private <T> Map<String, T> listByIds(
    ...
    try {
      ...
      if (idGetter != null) {
        ...
        com.wizzdi.runtime.security.UserSecurityContext securityContextPrincipal =
            (com.wizzdi.runtime.security.UserSecurityContext) securityContext.getPrincipal();
